...
//
//        Statement statement = connection.createStatement();     // создаем оператор для простого запроса (без параметров)
//        ResultSet rs = statement.executeQuery("SELECT * FROM aircraft;"); // выполняем запроса на поиск и получаем список ответов
//
//        while (rs.next()) {  // пока есть данные, продвигаться по ним
...
//        statement.setInt(2, eyesCount);  // "безопасное" добавление количества гла
//
//        int count =
